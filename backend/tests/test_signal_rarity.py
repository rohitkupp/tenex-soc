"""Unit tests for `app.detection.signal.rarity.detect_rarity`. Pure `EventRow` fixtures; no DB."""

from __future__ import annotations

from datetime import UTC, datetime, timedelta

from app.detection.signal.constants import RARITY_MAX_ORG_EVENT_COUNT, SIGNAL_RARITY
