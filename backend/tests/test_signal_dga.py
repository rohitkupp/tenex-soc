"""Unit tests for `app.detection.signal.dga`.
...
from app.detection.signal.dga import DGAArtifact, detect_dga, load_artifact, score_label
from app.detection.signal.dga_features import BigramModel
