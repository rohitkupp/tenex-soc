"""Unit tests for `app.detection.signal.url_path.detect_url_path` -- CLAUDE.md's "every detector
...
from app.detection.signal.constants import SIGNAL_URL_PATH
from app.detection.signal.events_dao import EventRow
from app.detection.signal.url_path import _is_high_entropy_token, detect_url_path
