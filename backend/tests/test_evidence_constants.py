"""`app.detection.evidence.constants`'s `detector_key` literals must stay byte-identical to
`datagen.types`'s `SIGNAL_*` constants, even though `app/detection/evidence/**` deliberately does
