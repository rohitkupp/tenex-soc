...
from app.detection.signal.constants import EVIDENCE_CAP

__all__ = ["SignalDraft", "cap_evidence", "clamp01"]
...
class SignalDraft:
    ...
    def to_signal_kwargs(self) -> dict[str, Any]:
        ...
        (DB-generated)."""
        from app.detection.signal.constants import DETECTOR_LAYER
